  ...
  return (
    <section id="services" className="py-32 relative bg-brand-bg">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        >
          <h2 className="font-display font-bold text-4xl md:text-6xl tracking-tighter mb-6 text-white">
            What You Get
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group p-8 rounded-[32px] bg-brand-card border border-white/5 hover:border-white/10 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden"
            >
              {/* Hover Glow Effect */}
